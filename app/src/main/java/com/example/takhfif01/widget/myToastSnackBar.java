package com.example.takhfif01.widget;
...
public class myToastSnackBar {
    ...
    public static void simpleSnackBarFloating(Activity activity,String message, ColorStateList colorBackgroundCardView, ColorStateList colorText) {
